...
Absorb is a reading and productivity tool. It does not provide medical, educational, legal, or professional advice. Reading speed and comprehension results can vary by person and material.
...
We may update, change, suspend, or discontinue parts of the app. We try to keep the app reliable, but it is provided without a guarantee that it will always be available or error free.

## Termination

We may suspend or terminate access to app features if you violate these terms, misuse the app, or if required by law, platform rules, or security needs. You may stop using the app at any time.

## Disclaimer and limitation of liability

To the fullest extent allowed by law, Absorb is provided as is and as available, without warranties of any kind. We are not liable for lost data, lost reading progress, subscription platform issues, or indirect damages except where liability cannot be limited by law.

## Changes to these terms

We may update these terms when the app, business model, or legal requirements change. Continued use of Absorb after an update means you accept the updated terms.
